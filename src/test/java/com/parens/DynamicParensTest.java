...
public class DynamicParensTest {
	...
	public void testValidExpressionTwo() {
		 ...
		 * ((1r1)x1)n(0a0) = 1
		 * 
		 * All other forms of the expression evaluate to 0 (false). Note: there are six such expressions.
		 * 
		 * (1r1)x(1n(0a0)) = 0
		 * (1r(1x(1n0)))a0 = 0
		 * (1r((1x1)n0))a0 = 0
    ...
    public void testCatalanOneHundred() throws IOException {
			 ...
			 * 200! / (101! * 100!)
			 */
			assertTrue(truths.equals(new BigInteger("896519947090131496687170070074100632420837521538745909320")));
    }
	
	/**
	 * Remove the ignore at your own risk. On a moderately fast quad-core desktop running a 32-bit IDE with maxed ram,
	 * the following test takes roughly 150-180 seconds to finish. Forcing 64-bit mode through command line or in a 64-bit
	 * IDE reduces runtime marginally.
	 * @throws IOException
	 */
	@Ignore
	@Test
    ...
    public void testCatalanOneThousandMixed() throws IOException {
		...
		BigInteger truths = parens.calculate();
		/*
		 * roughly 69.46% of the 1000th Catalan.
		 * (2000! / (1001! * 1000!)) * 0.6946 = ~ the number of true parenthesizations of 1a1n0a1n0a...0a1n0a
		 */
		assertTrue(truths.equals(new BigInteger(
